        ...
        return (
            <div className="flex-1 flex flex-col items-center justify-center px-6">
                <div className="text-center max-w-md">
                    <div className="w-20 h-20 mx-auto mb-6 rounded-2xl bg-gradient-to-br from-accent to-purple-400 flex items-center justify-center shadow-lg shadow-accent/20">
                ...
                {messages.map((message) => (
                    ...
                    >
                        {message.role === "assistant" && (
                            <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-accent to-purple-400 flex items-center justify-center shrink-0 mt-1">
                        ...
                        {message.role === "user" && (
                            <div className="w-8 h-8 rounded-lg bg-surface-active flex items-center justify-center shrink-0 mt-1">
